...
; simple copy program given in the previous section. The dump program
; reads an input file, specified in the CCP command line, and displays
; the content of each record in hexadecimal format at the console.
; Note that the dump program saves the CCP's stack upon entry, resets
; the stack to a local area, and restores the CCP's stack before
; returning directly to the CCP. Thus, the dump program does not
; perform a warm start at the end of processing.
;
