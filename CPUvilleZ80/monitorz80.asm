; This is a port of the simple machine language monitor program for
; the Intel 8080 microprocessor that appeared in the book "8080/Z80
; Assembly Language Techniques for Improved Programming" by Alan R.
; Miller. For details, including commands, see
; https://github.com/jefftranter/8080/tree/master/asm/monitor
;
; To run natively on the CPUville board only required changing the
...
STACK   EQU     ORGIN-60H
CSTAT   EQU     3H      ;CONSOLE STATUS
CDATA   EQU     2H      ;CONSOLE DATA
CSTATO  EQU     3H      ;CON OUT STATUS
CDATAO  EQU     2H      ;OUT DATA
