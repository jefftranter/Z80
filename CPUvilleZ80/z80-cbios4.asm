; BIO version that supports more drives rather than four. Adds
...
;	version 4, February 2023 by Jeff Tranter
...
;
disks:	equ	16		;number of disks in the system - set to 4, 8, or 16
...
bios:	equ	0FA00h		;base of bios
	...
	if	disks == 8
bios:	equ	0F7C0h		;base of bios
	endif
	if	disks == 16
bios:	equ	0F330h		;base of bios
	endif
