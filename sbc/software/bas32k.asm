...
; If you wish to use it elsewhere, please include an acknowledgment to myself.
;
...
;
; Ported to z80asm assembler by Jeff Tranter <tranter@pobox.com>.
;
;==================================================================================
