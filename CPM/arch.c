/*
  ...
  To Do:
  stat() is not working under CP/M with z88dk.
...
int main(int argc, char **argv)
{
    ...
    /* Make sure that output file does not already exist, otherwise refuse to continue. */
    ...
    for (i = 2; i < numfiles + 2; i++) {
        ...
        fprintf(afp, "%c%c%c%c",
               (char)(statbuf.st_size >> 24),
               (char)(statbuf.st_size >> 16),
               (char)(statbuf.st_size >> 8),
